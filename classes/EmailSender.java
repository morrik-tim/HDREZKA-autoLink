...
public class EmailSender {
    ...
    private static String openUrlData;
            ...
            if (jsonFile.exists() && jsonFile.length() > 0) {
                ...
                if (!urlList.isEmpty()) {
                    ...
                    if (latestUrlData.getDate().equals(currentDate)) {
                        openUrlData = latestUrlData.getUrl();
    ...
    public void sendEmail() {
        ...
        try {
            ...
            if (openUrlFromJson()) {
                ...
                System.out.println("Открываем ссылку из JSON файла: " + openUrlData);
                OpenBrowser.openBrowser(openUrlData);
                System.exit(0);
            } else {
